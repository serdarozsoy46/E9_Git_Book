package com.cyberteck.day11;

import com.cyberteck.utilities.ExcelUtil;
...
public class MethodSourceParameterizedTest {
    ...
    public static List<Map<String,String>> getExcelData(){
        ...
        ExcelUtil vytrackFile = new ExcelUtil("src/main/resources/Vytracktestdata.xlsx","QA3-all");
