...
public class SpartanAdminGetTest {
    ...
    public static void init(){
        ...
        baseURI = "http://52.207.225.148:7000";
    ...
    public void getOneSpartanAssertion(){
        ...
        Ensure.that("Status code is 200", validatableResponse -> validatableResponse.statusCode(200) );// if you put wrong one rest still run
